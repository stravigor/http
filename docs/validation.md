...
```typescript
import { validate, required, string, integer, min, max, email } from '@stravigor/core/validation'
...
```typescript
import { required, string, min, max, email, enumOf, oneOf, regex } from '@stravigor/core/validation'
...
import { enumOf, string } from '@stravigor/core/validation'
import { UserRole } from '../enums/user'
...
```typescript
import type { Rule } from '@stravigor/core/validation'
