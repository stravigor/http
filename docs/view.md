...
```typescript
import { ViewEngine, view } from '@stravigor/core/view'
...
```typescript
import { IslandBuilder } from '@stravigor/core/view'
...
import '@stravigor/core/view/client/islands'
```
...
```typescript
import { staticFiles } from '@stravigor/core/view'
